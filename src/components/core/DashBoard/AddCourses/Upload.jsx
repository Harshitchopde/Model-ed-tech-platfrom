        ...
        flex minh-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-richblack-500`}>
          ...
          ? <div className=" flex w-full flex-col p-6">
            ...
            {!viewData && (
              ...
              className=' mt-4 text-richblack-400 underline'>
                Cancel
              </button>
            )}
          </div>
          : (
            ...
            {...getRootProps()}>
              ...
              <p className=' mt-2 max-w-[200px] text-center text-sm text-richblack-200'>
                Drag and Drop an {video? "video":"image"}, or click to {" "} <span className=' font-semibold text-yellow-50 hover:underline'>Browse</span> a file
              </p>
              <ul className=' mt-10 flex list-disc justify-between space-x-12 text-center text-xs text-richblack-200'>
                <li>Aspect retio 16:9</li>
